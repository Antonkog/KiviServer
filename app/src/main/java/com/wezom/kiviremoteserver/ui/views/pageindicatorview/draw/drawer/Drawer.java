package com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer;
...
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.BasicDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.ColorDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.DropDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.FillDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.ScaleDownDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.ScaleDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.SlideDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.SwapDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.ThinWormDrawer;
import com.wezom.kiviremoteserver.ui.views.pageindicatorview.draw.drawer.type.WormDrawer;
...
public class Drawer {
    ...
    public void drawWorm(@NonNull Canvas canvas, Boolean isSelectedItem, @NonNull Value value) {
        if (wormDrawer != null) {
            wormDrawer.draw(canvas, position, isSelectedItem, value, coordinateX, coordinateY);
        }
    }
