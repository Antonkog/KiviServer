...
public class InputSourceHelper {
    ...
    public enum INPUT_PORT {
        ...
        INPUT_SOURCE_CVBS5(6, "cvbs5", R.string.input_cvbs, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_CVBS6(7, "cvbs6", R.string.input_cvbs, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_CVBS7(8, "cvbs7", R.string.input_cvbs, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_CVBS8(9, "cvbs8", R.string.input_cvbs, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_CVBS_MAX(10, "cvbs_max", R.string.input_cvbs, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_SVIDEO(11, "svideo", R.string.input_svideo, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_SVIDEO2(12, "svideo2", R.string.input_svideo, R.drawable.ic_settings_time, 10),
        ...
        INPUT_SOURCE_SCART(20, "scart", R.string.input_scart, R.drawable.ic_settings_time, 10),
        ...
        INPUT_SOURCE_DVI4(32, "dvi4", R.string.dvi, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_DVI_MAX(33, "dvi_max", R.string.dvi, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_STORAGE(34, "storage", R.string.input_storage, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_KTV(35, "ktv", R.string.input_ktv, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_JPEG(36, "jpeg", R.string.input_jpeg, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_DTV2(37, "dtv2", R.string.input_dtv, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_STORAGE2(38, "storege2", R.string.input_storage, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_DIV3(39, "div3", R.string.dvi, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_SCALER_OP(40, "scaler_op", R.string.input_scaler_op, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_RUV(41, "ruv", R.string.input_ruv, R.drawable.ic_settings_time, 10),
        INPUT_SOURCE_VGA2(42, "vga2", R.string.input_vga, R.drawable.ic_settings_time, 10),
