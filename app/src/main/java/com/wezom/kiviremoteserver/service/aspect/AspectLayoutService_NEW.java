...
//            mainText.getPaint().setDither(false);
//            mainText.getPaint().setLinearText(true);
//            mainText.getPaint().setStrokeWidth(0.2f);
//            mainText.getPaint().setStyle(Paint.Style.STROKE);
        }
    }
