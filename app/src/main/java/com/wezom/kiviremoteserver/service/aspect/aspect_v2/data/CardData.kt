...
object Cards {
    private val inputsData = CardData(0,R.drawable.ic_hdmi_icon_copy, R.string.inputs, R.string.empty_str, showActionsView = true)
    private val numericData = CardData(1,R.drawable.ic_numeric_icon, R.string.keyboard, R.string.keyboard_desk)
    private val pictureData = CardData(2,R.drawable.ic_group_3_copy_6, R.string.picture, R.string.atv, PictureMode.getModes(), showActionsView = true)
    private val ratioData = CardData(3,R.drawable.ic_screen_orientation_icon, R.string.ratio, R.string.hdmi, Ratio.getRatios())
    private val settingsData = CardData(4,R.drawable.ic_settings_icon, R.string.settings, R.string.settings_desk)
    private val soundData = CardData(5, R.drawable.ic_sound_icon, R.string.sound, R.string.atv, SoundValues.getModes(), showActionsView = true)
    private val timerData = CardData(6,R.drawable.ic_clock_icon, R.string.sleep, R.string.sleep, listOf(
